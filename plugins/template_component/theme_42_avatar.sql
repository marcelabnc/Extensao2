...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(84074718230608939978)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(84074718585305939980)
,p_plugin_id=>wwv_flow_imp.id(84074718230608939978)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(84074718817247939981)
,p_plugin_attribute_id=>wwv_flow_imp.id(84074718585305939980)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'IMAGE'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(84074719268237939981)
,p_plugin_attribute_id=>wwv_flow_imp.id(84074718585305939980)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(84074719632445939982)
,p_plugin_attribute_id=>wwv_flow_imp.id(84074718585305939980)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(84074720040640939982)
,p_plugin_id=>wwv_flow_imp.id(84074718230608939978)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(84074718585305939980)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(84074720347633939983)
,p_plugin_id=>wwv_flow_imp.id(84074718230608939978)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(84074720645935939983)
,p_plugin_id=>wwv_flow_imp.id(84074718230608939978)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(84074720991862939983)
,p_plugin_id=>wwv_flow_imp.id(84074718230608939978)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(84074721261138939983)
,p_plugin_id=>wwv_flow_imp.id(84074718230608939978)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(84074721508464939984)
,p_plugin_attribute_id=>wwv_flow_imp.id(84074721261138939983)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(84074721995715939984)
,p_plugin_attribute_id=>wwv_flow_imp.id(84074721261138939983)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(84074722360835939984)
,p_plugin_attribute_id=>wwv_flow_imp.id(84074721261138939983)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(84074722774017939985)
,p_plugin_attribute_id=>wwv_flow_imp.id(84074721261138939983)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(84074723159823939985)
,p_plugin_id=>wwv_flow_imp.id(84074718230608939978)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(84074723475208939985)
,p_plugin_attribute_id=>wwv_flow_imp.id(84074723159823939985)
,p_display_sequence=>10
,p_display_value=>'Extra Extra Small'
,p_return_value=>'t-Avatar--xxs'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(84074723817866939986)
,p_plugin_attribute_id=>wwv_flow_imp.id(84074723159823939985)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(84074724290898939986)
,p_plugin_attribute_id=>wwv_flow_imp.id(84074723159823939985)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(84074724695155939986)
,p_plugin_attribute_id=>wwv_flow_imp.id(84074723159823939985)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(84074725091068939987)
,p_plugin_attribute_id=>wwv_flow_imp.id(84074723159823939985)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(84074725458978939987)
,p_plugin_attribute_id=>wwv_flow_imp.id(84074723159823939985)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(84074725885657939987)
,p_plugin_attribute_id=>wwv_flow_imp.id(84074723159823939985)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(84074726258470939988)
,p_plugin_id=>wwv_flow_imp.id(84074718230608939978)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(85874769160831053732)
,p_plugin_id=>wwv_flow_imp.id(84074718230608939978)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
