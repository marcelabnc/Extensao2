...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(84074746258869940012)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(86001984110619011710)
,p_plugin_id=>wwv_flow_imp.id(84074746258869940012)
,p_title=>'Avatar'
,p_display_sequence=>10
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(86001983555607011709)
,p_plugin_id=>wwv_flow_imp.id(84074746258869940012)
,p_title=>'Badge'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(85745091491876738196)
,p_plugin_id=>wwv_flow_imp.id(84074746258869940012)
,p_title=>'Appearance'
,p_display_sequence=>30
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(84074747157512940016)
,p_plugin_id=>wwv_flow_imp.id(84074746258869940012)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(84074747425084940017)
,p_plugin_id=>wwv_flow_imp.id(84074746258869940012)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(84074747744307940017)
,p_plugin_id=>wwv_flow_imp.id(84074746258869940012)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(84074748020728940017)
,p_plugin_id=>wwv_flow_imp.id(84074746258869940012)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(84074748383091940018)
,p_plugin_id=>wwv_flow_imp.id(84074746258869940012)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(84074748611535940018)
,p_plugin_id=>wwv_flow_imp.id(84074746258869940012)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(84074748979965940018)
,p_plugin_id=>wwv_flow_imp.id(84074746258869940012)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(84074748383091940018)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(86001984110619011710)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(84074749238051940019)
,p_plugin_attribute_id=>wwv_flow_imp.id(84074748979965940018)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(84074749624571940019)
,p_plugin_attribute_id=>wwv_flow_imp.id(84074748979965940018)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(84074750006446940019)
,p_plugin_attribute_id=>wwv_flow_imp.id(84074748979965940018)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(84074750448825940020)
,p_plugin_id=>wwv_flow_imp.id(84074746258869940012)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(84074748979965940018)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(84074750713733940020)
,p_plugin_id=>wwv_flow_imp.id(84074746258869940012)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(84074751009278940020)
,p_plugin_id=>wwv_flow_imp.id(84074746258869940012)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(84074751349161940021)
,p_plugin_id=>wwv_flow_imp.id(84074746258869940012)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(84074751685616940021)
,p_plugin_id=>wwv_flow_imp.id(84074746258869940012)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(84074751980996940021)
,p_plugin_attribute_id=>wwv_flow_imp.id(84074751685616940021)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(84074752303154940022)
,p_plugin_attribute_id=>wwv_flow_imp.id(84074751685616940021)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(84074752747512940025)
,p_plugin_attribute_id=>wwv_flow_imp.id(84074751685616940021)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(84074753109848940026)
,p_plugin_attribute_id=>wwv_flow_imp.id(84074751685616940021)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(84074753580552940026)
,p_plugin_id=>wwv_flow_imp.id(84074746258869940012)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'RAW'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(84074748611535940018)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_attribute_group_id=>wwv_flow_imp.id(86001983555607011709)
,p_help_text=>'Enter a value for the badge label or select a source column from the quick pick options.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(84074753853131940026)
,p_plugin_id=>wwv_flow_imp.id(84074746258869940012)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(84074754150197940026)
,p_plugin_id=>wwv_flow_imp.id(84074746258869940012)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(84074754450932940027)
,p_plugin_id=>wwv_flow_imp.id(84074746258869940012)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(84074754743278940027)
,p_plugin_id=>wwv_flow_imp.id(84074746258869940012)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(84074755062491940028)
,p_plugin_id=>wwv_flow_imp.id(84074746258869940012)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(84074755325982940028)
,p_plugin_attribute_id=>wwv_flow_imp.id(84074755062491940028)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(84074755737987940028)
,p_plugin_attribute_id=>wwv_flow_imp.id(84074755062491940028)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(84074756124910940029)
,p_plugin_id=>wwv_flow_imp.id(84074746258869940012)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(84074756420521940029)
,p_plugin_attribute_id=>wwv_flow_imp.id(84074756124910940029)
,p_display_sequence=>10
,p_display_value=>'Rounded'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(84074756874611940029)
,p_plugin_attribute_id=>wwv_flow_imp.id(84074756124910940029)
,p_display_sequence=>20
,p_display_value=>'Circular'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(84074757243971940030)
,p_plugin_attribute_id=>wwv_flow_imp.id(84074756124910940029)
,p_display_sequence=>30
,p_display_value=>'Square'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(84074757678806940030)
,p_plugin_attribute_id=>wwv_flow_imp.id(84074756124910940029)
,p_display_sequence=>40
,p_display_value=>'No Shape'
,p_return_value=>'t-Avatar--noShape'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(84074758036444940030)
,p_plugin_id=>wwv_flow_imp.id(84074746258869940012)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(84074758325144940031)
,p_plugin_attribute_id=>wwv_flow_imp.id(84074758036444940030)
,p_display_sequence=>10
,p_display_value=>'Extra Extra Small'
,p_return_value=>'t-Avatar--xxs'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(84074758769045940031)
,p_plugin_attribute_id=>wwv_flow_imp.id(84074758036444940030)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(84074759151975940031)
,p_plugin_attribute_id=>wwv_flow_imp.id(84074758036444940030)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(84074759503991940032)
,p_plugin_attribute_id=>wwv_flow_imp.id(84074758036444940030)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(84074759914607940032)
,p_plugin_attribute_id=>wwv_flow_imp.id(84074758036444940030)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(84074760303325940032)
,p_plugin_attribute_id=>wwv_flow_imp.id(84074758036444940030)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(84074760750490940033)
,p_plugin_attribute_id=>wwv_flow_imp.id(84074758036444940030)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(84074761114971940033)
,p_plugin_id=>wwv_flow_imp.id(84074746258869940012)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(84074761492552940033)
,p_plugin_attribute_id=>wwv_flow_imp.id(84074761114971940033)
,p_display_sequence=>10
,p_display_value=>'Small'
,p_return_value=>'t-Badge--sm'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(84074761844477940034)
,p_plugin_attribute_id=>wwv_flow_imp.id(84074761114971940033)
,p_display_sequence=>20
,p_display_value=>'Medium'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(84074762294267940034)
,p_plugin_attribute_id=>wwv_flow_imp.id(84074761114971940033)
,p_display_sequence=>30
,p_display_value=>'Large'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(84074762671924940034)
,p_plugin_id=>wwv_flow_imp.id(84074746258869940012)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(84074762923464940035)
,p_plugin_attribute_id=>wwv_flow_imp.id(84074762671924940034)
,p_display_sequence=>10
,p_display_value=>'Small'
,p_return_value=>'t-ContentRow-badge--sm'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(84074763340639940035)
,p_plugin_attribute_id=>wwv_flow_imp.id(84074762671924940034)
,p_display_sequence=>20
,p_display_value=>'Medium'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(84074763740983940035)
,p_plugin_attribute_id=>wwv_flow_imp.id(84074762671924940034)
,p_display_sequence=>30
,p_display_value=>'Large'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(84074764191241940036)
,p_plugin_attribute_id=>wwv_flow_imp.id(84074762671924940034)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(84074764561908940036)
,p_plugin_id=>wwv_flow_imp.id(84074746258869940012)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(84074764830844940036)
,p_plugin_attribute_id=>wwv_flow_imp.id(84074764561908940036)
,p_display_sequence=>10
,p_display_value=>'End'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(84074765237728940037)
,p_plugin_id=>wwv_flow_imp.id(84074746258869940012)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(84074765521201940037)
,p_plugin_attribute_id=>wwv_flow_imp.id(84074765237728940037)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(84074765907021940037)
,p_plugin_attribute_id=>wwv_flow_imp.id(84074765237728940037)
,p_display_sequence=>20
,p_display_value=>'End'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(84074766375303940038)
,p_plugin_id=>wwv_flow_imp.id(84074746258869940012)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(84074766660497940038)
,p_plugin_id=>wwv_flow_imp.id(84074746258869940012)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(84074766919196940038)
,p_plugin_id=>wwv_flow_imp.id(84074746258869940012)
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_attribute_group_id=>wwv_flow_imp.id(85745091491876738196)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(84074767245650940038)
,p_plugin_id=>wwv_flow_imp.id(84074746258869940012)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(84074767590117940039)
,p_plugin_attribute_id=>wwv_flow_imp.id(84074767245650940038)
,p_display_sequence=>10
,p_display_value=>'Compact'
,p_return_value=>'t-ContentRow--styleCompact'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(84074767925535940039)
,p_plugin_id=>wwv_flow_imp.id(84074746258869940012)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(84074768273737940039)
,p_plugin_id=>wwv_flow_imp.id(84074746258869940012)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(85883198000834833324)
,p_plugin_id=>wwv_flow_imp.id(84074746258869940012)
,p_name=>'Button'
,p_type=>'BUTTON'
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(85883199260354837472)
,p_plugin_id=>wwv_flow_imp.id(84074746258869940012)
,p_name=>'Menu'
,p_type=>'MENU'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(85586246485939074894)
,p_plugin_id=>wwv_flow_imp.id(84074746258869940012)
,p_name=>'Badge Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(85869604372160426591)
,p_plugin_id=>wwv_flow_imp.id(84074746258869940012)
,p_name=>'Title Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(85870283672890509695)
,p_plugin_id=>wwv_flow_imp.id(84074746258869940012)
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(85883196065767788338)
,p_plugin_id=>wwv_flow_imp.id(84074746258869940012)
,p_name=>'Avatar Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(85883197399157802195)
,p_plugin_id=>wwv_flow_imp.id(84074746258869940012)
