...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(84074773592864940048)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(85874791924795823700)
,p_plugin_id=>wwv_flow_imp.id(84074773592864940048)
,p_title=>'Avatar'
,p_display_sequence=>10
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(85874791369783823699)
,p_plugin_id=>wwv_flow_imp.id(84074773592864940048)
,p_title=>'Badge'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(84074774293729940051)
,p_plugin_id=>wwv_flow_imp.id(84074773592864940048)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(84074774562146940052)
,p_plugin_id=>wwv_flow_imp.id(84074773592864940048)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(84074774864930940052)
,p_plugin_id=>wwv_flow_imp.id(84074773592864940048)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(84074775190486940052)
,p_plugin_id=>wwv_flow_imp.id(84074773592864940048)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(84074775458056940053)
,p_plugin_id=>wwv_flow_imp.id(84074773592864940048)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(84074774864930940052)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(85874791924795823700)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(84074775742999940053)
,p_plugin_attribute_id=>wwv_flow_imp.id(84074775458056940053)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(84074776128259940053)
,p_plugin_attribute_id=>wwv_flow_imp.id(84074775458056940053)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(84074776541239940053)
,p_plugin_attribute_id=>wwv_flow_imp.id(84074775458056940053)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(84074776933639940054)
,p_plugin_id=>wwv_flow_imp.id(84074773592864940048)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(84074775458056940053)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(84074777240588940054)
,p_plugin_id=>wwv_flow_imp.id(84074773592864940048)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(84074777585430940054)
,p_plugin_id=>wwv_flow_imp.id(84074773592864940048)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(84074777800741940055)
,p_plugin_id=>wwv_flow_imp.id(84074773592864940048)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(84074778166434940055)
,p_plugin_id=>wwv_flow_imp.id(84074773592864940048)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(84074778487722940055)
,p_plugin_attribute_id=>wwv_flow_imp.id(84074778166434940055)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(84074778875628940056)
,p_plugin_attribute_id=>wwv_flow_imp.id(84074778166434940055)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(84074779288513940056)
,p_plugin_attribute_id=>wwv_flow_imp.id(84074778166434940055)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(84074779631457940056)
,p_plugin_attribute_id=>wwv_flow_imp.id(84074778166434940055)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(84074780026878940057)
,p_plugin_id=>wwv_flow_imp.id(84074773592864940048)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'RAW'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(84074775190486940052)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_attribute_group_id=>wwv_flow_imp.id(85874791369783823699)
,p_help_text=>'Enter a value for the badge label or select a source column from the quick pick options.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(84074780397603940057)
,p_plugin_id=>wwv_flow_imp.id(84074773592864940048)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(84074780667938940057)
,p_plugin_id=>wwv_flow_imp.id(84074773592864940048)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(84074780960605940058)
,p_plugin_id=>wwv_flow_imp.id(84074773592864940048)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(84074781296621940058)
,p_plugin_id=>wwv_flow_imp.id(84074773592864940048)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(84074781554253940058)
,p_plugin_id=>wwv_flow_imp.id(84074773592864940048)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(84074781840595940059)
,p_plugin_attribute_id=>wwv_flow_imp.id(84074781554253940058)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(84074782254038940059)
,p_plugin_attribute_id=>wwv_flow_imp.id(84074781554253940058)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(84074782613848940059)
,p_plugin_id=>wwv_flow_imp.id(84074773592864940048)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(84074782959090940060)
,p_plugin_attribute_id=>wwv_flow_imp.id(84074782613848940059)
,p_display_sequence=>10
,p_display_value=>'Rounded'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(84074783302500940060)
,p_plugin_attribute_id=>wwv_flow_imp.id(84074782613848940059)
,p_display_sequence=>20
,p_display_value=>'Circular'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(84074783727878940060)
,p_plugin_attribute_id=>wwv_flow_imp.id(84074782613848940059)
,p_display_sequence=>30
,p_display_value=>'Square'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(84074784168687940060)
,p_plugin_id=>wwv_flow_imp.id(84074773592864940048)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(84074784469959940061)
,p_plugin_attribute_id=>wwv_flow_imp.id(84074784168687940060)
,p_display_sequence=>10
,p_display_value=>'2 Column Grid'
,p_return_value=>'t-MediaList--cols t-MediaList--2cols'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(84074784832239940061)
,p_plugin_attribute_id=>wwv_flow_imp.id(84074784168687940060)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(84074785283712940061)
,p_plugin_attribute_id=>wwv_flow_imp.id(84074784168687940060)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(84074785693655940062)
,p_plugin_attribute_id=>wwv_flow_imp.id(84074784168687940060)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(84074786030129940062)
,p_plugin_attribute_id=>wwv_flow_imp.id(84074784168687940060)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(84074786452309940062)
,p_plugin_id=>wwv_flow_imp.id(84074773592864940048)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(84074786778422940063)
,p_plugin_attribute_id=>wwv_flow_imp.id(84074786452309940062)
,p_display_sequence=>10
,p_display_value=>'Large'
,p_return_value=>'t-MediaList--large force-fa-lg'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(84074787176494940063)
,p_plugin_id=>wwv_flow_imp.id(84074773592864940048)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(85874994976952970328)
,p_plugin_id=>wwv_flow_imp.id(84074773592864940048)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
