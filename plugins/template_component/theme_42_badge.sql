...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(84074727338979939990)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(84074727649659939991)
,p_plugin_id=>wwv_flow_imp.id(84074727338979939990)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(84074727937578939992)
,p_plugin_id=>wwv_flow_imp.id(84074727338979939990)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(84074728215699939992)
,p_plugin_id=>wwv_flow_imp.id(84074727338979939990)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(84074728546939939992)
,p_plugin_id=>wwv_flow_imp.id(84074727338979939990)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(84074728844730939992)
,p_plugin_id=>wwv_flow_imp.id(84074727338979939990)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(84074729134998939993)
,p_plugin_id=>wwv_flow_imp.id(84074727338979939990)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(84074729459425939993)
,p_plugin_attribute_id=>wwv_flow_imp.id(84074729134998939993)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(84074729841913939993)
,p_plugin_attribute_id=>wwv_flow_imp.id(84074729134998939993)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(84074730282597939993)
,p_plugin_id=>wwv_flow_imp.id(84074727338979939990)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(84074730567498939994)
,p_plugin_attribute_id=>wwv_flow_imp.id(84074730282597939993)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(84074730944687939994)
,p_plugin_attribute_id=>wwv_flow_imp.id(84074730282597939993)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(84074731332611939994)
,p_plugin_attribute_id=>wwv_flow_imp.id(84074730282597939993)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(84074731742529939995)
,p_plugin_id=>wwv_flow_imp.id(84074727338979939990)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(84074732075021939995)
,p_plugin_attribute_id=>wwv_flow_imp.id(84074731742529939995)
,p_display_sequence=>10
,p_display_value=>'Small'
,p_return_value=>'t-Badge--sm'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(84074732476605939995)
,p_plugin_attribute_id=>wwv_flow_imp.id(84074731742529939995)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(84074732890990939995)
,p_plugin_attribute_id=>wwv_flow_imp.id(84074731742529939995)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(85586209641844042180)
,p_plugin_id=>wwv_flow_imp.id(84074727338979939990)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
