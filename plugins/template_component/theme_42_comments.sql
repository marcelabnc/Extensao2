...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(84074736197757939999)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(85874621616308971717)
,p_plugin_id=>wwv_flow_imp.id(84074736197757939999)
,p_title=>'Avatar'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(84074736655854940002)
,p_plugin_id=>wwv_flow_imp.id(84074736197757939999)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(84074736942601940002)
,p_plugin_id=>wwv_flow_imp.id(84074736197757939999)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(84074737200920940003)
,p_plugin_id=>wwv_flow_imp.id(84074736197757939999)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(84074737581602940003)
,p_plugin_id=>wwv_flow_imp.id(84074736197757939999)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(84074737849143940003)
,p_plugin_id=>wwv_flow_imp.id(84074736197757939999)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(84074742431905940007)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(85874621616308971717)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(84074738129158940003)
,p_plugin_attribute_id=>wwv_flow_imp.id(84074737849143940003)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(84074738563195940004)
,p_plugin_attribute_id=>wwv_flow_imp.id(84074737849143940003)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(84074738962780940004)
,p_plugin_attribute_id=>wwv_flow_imp.id(84074737849143940003)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(84074739306022940004)
,p_plugin_id=>wwv_flow_imp.id(84074736197757939999)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(84074737849143940003)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(84074739606784940005)
,p_plugin_id=>wwv_flow_imp.id(84074736197757939999)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(84074739903251940005)
,p_plugin_id=>wwv_flow_imp.id(84074736197757939999)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(84074740236894940005)
,p_plugin_id=>wwv_flow_imp.id(84074736197757939999)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(84074740563203940005)
,p_plugin_id=>wwv_flow_imp.id(84074736197757939999)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(84074740836397940006)
,p_plugin_attribute_id=>wwv_flow_imp.id(84074740563203940005)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(84074741246622940006)
,p_plugin_attribute_id=>wwv_flow_imp.id(84074740563203940005)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(84074741626947940006)
,p_plugin_attribute_id=>wwv_flow_imp.id(84074740563203940005)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(84074742046664940007)
,p_plugin_attribute_id=>wwv_flow_imp.id(84074740563203940005)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(84074742431905940007)
,p_plugin_id=>wwv_flow_imp.id(84074736197757939999)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(84074742792134940007)
,p_plugin_id=>wwv_flow_imp.id(84074736197757939999)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(84074743007387940007)
,p_plugin_id=>wwv_flow_imp.id(84074736197757939999)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(84074743320332940008)
,p_plugin_attribute_id=>wwv_flow_imp.id(84074743007387940007)
,p_display_sequence=>10
,p_display_value=>'Basic'
,p_return_value=>'t-Comments--basic'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(84074743719654940008)
,p_plugin_attribute_id=>wwv_flow_imp.id(84074743007387940007)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(84074744157244940008)
,p_plugin_id=>wwv_flow_imp.id(84074736197757939999)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(85874754283742073220)
,p_plugin_id=>wwv_flow_imp.id(84074736197757939999)
,p_name=>'Link'
,p_type=>'BUTTON'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(85874753692237065763)
,p_plugin_id=>wwv_flow_imp.id(84074736197757939999)
,p_name=>'Actions'
,p_static_id=>'ACTIONS'
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(85874809315907047642)
,p_plugin_id=>wwv_flow_imp.id(84074736197757939999)
,p_name=>'Avatar Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(85874961533619918413)
,p_plugin_id=>wwv_flow_imp.id(84074736197757939999)
