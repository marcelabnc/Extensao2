...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(84074618173948939935)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84074618429916939935)
,p_plug_template_id=>wwv_flow_imp.id(84074618173948939935)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84074618702437939935)
,p_plug_template_id=>wwv_flow_imp.id(84074618173948939935)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84074619049019939935)
,p_plug_template_id=>wwv_flow_imp.id(84074618173948939935)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84074619356570939935)
,p_plug_template_id=>wwv_flow_imp.id(84074618173948939935)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84074619667662939935)
,p_plug_template_id=>wwv_flow_imp.id(84074618173948939935)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84074619976424939935)
,p_plug_template_id=>wwv_flow_imp.id(84074618173948939935)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84074620243518939935)
,p_plug_template_id=>wwv_flow_imp.id(84074618173948939935)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84074620528952939935)
,p_plug_template_id=>wwv_flow_imp.id(84074618173948939935)
,p_name=>'Sub Regions'
