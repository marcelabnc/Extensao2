...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(84074612738417939932)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84074613030136939933)
,p_plug_template_id=>wwv_flow_imp.id(84074612738417939932)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84074613388902939933)
,p_plug_template_id=>wwv_flow_imp.id(84074612738417939932)
,p_name=>'Sub Regions'
