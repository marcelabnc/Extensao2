...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(84074634849183939941)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84074635125647939941)
,p_plug_template_id=>wwv_flow_imp.id(84074634849183939941)
,p_name=>'Item'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84074635427742939941)
,p_plug_template_id=>wwv_flow_imp.id(84074634849183939941)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84074635787700939942)
,p_plug_template_id=>wwv_flow_imp.id(84074634849183939941)
,p_name=>'Button Start'
