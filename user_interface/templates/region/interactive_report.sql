...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(84074632742269939940)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84074633032140939940)
,p_plug_template_id=>wwv_flow_imp.id(84074632742269939940)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84074633374540939940)
,p_plug_template_id=>wwv_flow_imp.id(84074632742269939940)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84074633618056939941)
,p_plug_template_id=>wwv_flow_imp.id(84074632742269939940)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84074633920275939941)
,p_plug_template_id=>wwv_flow_imp.id(84074632742269939940)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84074634238989939941)
,p_plug_template_id=>wwv_flow_imp.id(84074632742269939940)
,p_name=>'Sub Regions'
