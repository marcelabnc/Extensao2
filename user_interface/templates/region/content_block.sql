...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(84074604697871939929)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84074604982511939929)
,p_plug_template_id=>wwv_flow_imp.id(84074604697871939929)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84074605248386939929)
,p_plug_template_id=>wwv_flow_imp.id(84074604697871939929)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84074605579536939929)
,p_plug_template_id=>wwv_flow_imp.id(84074604697871939929)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84074605871204939930)
,p_plug_template_id=>wwv_flow_imp.id(84074604697871939929)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84074606191010939930)
,p_plug_template_id=>wwv_flow_imp.id(84074604697871939929)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84074606493543939930)
,p_plug_template_id=>wwv_flow_imp.id(84074604697871939929)
,p_name=>'Sub Regions'
