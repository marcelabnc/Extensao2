...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(84074654987731939949)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84074655269616939949)
,p_plug_template_id=>wwv_flow_imp.id(84074654987731939949)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84074655542427939950)
,p_plug_template_id=>wwv_flow_imp.id(84074654987731939949)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84074655832442939950)
,p_plug_template_id=>wwv_flow_imp.id(84074654987731939949)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84074656100171939950)
,p_plug_template_id=>wwv_flow_imp.id(84074654987731939949)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84074656498132939950)
,p_plug_template_id=>wwv_flow_imp.id(84074654987731939949)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84074656756160939950)
,p_plug_template_id=>wwv_flow_imp.id(84074654987731939949)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84074657045788939950)
,p_plug_template_id=>wwv_flow_imp.id(84074654987731939949)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84074657374928939950)
,p_plug_template_id=>wwv_flow_imp.id(84074654987731939949)
,p_name=>'Help'
,p_placeholder=>'HELP'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84074657676160939950)
,p_plug_template_id=>wwv_flow_imp.id(84074654987731939949)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84074657902642939951)
,p_plug_template_id=>wwv_flow_imp.id(84074654987731939949)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84074658293287939951)
,p_plug_template_id=>wwv_flow_imp.id(84074654987731939949)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84074658591007939951)
,p_plug_template_id=>wwv_flow_imp.id(84074654987731939949)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84074658839300939951)
,p_plug_template_id=>wwv_flow_imp.id(84074654987731939949)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
