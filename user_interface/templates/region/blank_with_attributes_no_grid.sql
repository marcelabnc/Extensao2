...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(84073977325202939918)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84073977660455939918)
,p_plug_template_id=>wwv_flow_imp.id(84073977325202939918)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84073977918605939918)
,p_plug_template_id=>wwv_flow_imp.id(84073977325202939918)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84073978242593939918)
,p_plug_template_id=>wwv_flow_imp.id(84073977325202939918)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84073978523646939918)
,p_plug_template_id=>wwv_flow_imp.id(84073977325202939918)
,p_name=>'Sub Regions'
