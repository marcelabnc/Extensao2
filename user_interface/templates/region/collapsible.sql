...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(84073994839674939925)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84073995168082939925)
,p_plug_template_id=>wwv_flow_imp.id(84073994839674939925)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84073995423480939925)
,p_plug_template_id=>wwv_flow_imp.id(84073994839674939925)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84073995733716939925)
,p_plug_template_id=>wwv_flow_imp.id(84073994839674939925)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84073996063250939925)
,p_plug_template_id=>wwv_flow_imp.id(84073994839674939925)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84073996388634939926)
,p_plug_template_id=>wwv_flow_imp.id(84073994839674939925)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84073996670308939926)
,p_plug_template_id=>wwv_flow_imp.id(84073994839674939925)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84073996993687939926)
,p_plug_template_id=>wwv_flow_imp.id(84073994839674939925)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84073997207255939926)
,p_plug_template_id=>wwv_flow_imp.id(84073994839674939925)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84073997568510939926)
,p_plug_template_id=>wwv_flow_imp.id(84073994839674939925)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84073997877200939926)
,p_plug_template_id=>wwv_flow_imp.id(84073994839674939925)
,p_name=>'Sub Regions'
