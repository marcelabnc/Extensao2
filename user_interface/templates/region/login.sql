...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(84074637305566939943)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84074637631812939943)
,p_plug_template_id=>wwv_flow_imp.id(84074637305566939943)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84074637954785939943)
,p_plug_template_id=>wwv_flow_imp.id(84074637305566939943)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84074638206849939943)
,p_plug_template_id=>wwv_flow_imp.id(84074637305566939943)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84074638581511939943)
,p_plug_template_id=>wwv_flow_imp.id(84074637305566939943)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84074638887562939943)
,p_plug_template_id=>wwv_flow_imp.id(84074637305566939943)
,p_name=>'Sub Regions'
