...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(84073975910040939917)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84073976285498939917)
,p_plug_template_id=>wwv_flow_imp.id(84073975910040939917)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84073976593218939917)
,p_plug_template_id=>wwv_flow_imp.id(84073975910040939917)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84073976809066939917)
,p_plug_template_id=>wwv_flow_imp.id(84073975910040939917)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84073977102146939918)
,p_plug_template_id=>wwv_flow_imp.id(84073975910040939917)
,p_name=>'Sub Regions'
