...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(84074652367671939948)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84074652637600939949)
,p_plug_template_id=>wwv_flow_imp.id(84074652367671939948)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84074652956147939949)
,p_plug_template_id=>wwv_flow_imp.id(84074652367671939948)
,p_name=>'Tabs'
