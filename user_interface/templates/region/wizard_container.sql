...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(84074660028486939951)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84074660365727939952)
,p_plug_template_id=>wwv_flow_imp.id(84074660028486939951)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84074660677669939952)
,p_plug_template_id=>wwv_flow_imp.id(84074660028486939951)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84074660967715939952)
,p_plug_template_id=>wwv_flow_imp.id(84074660028486939951)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84074661283682939952)
,p_plug_template_id=>wwv_flow_imp.id(84074660028486939951)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84074661585433939952)
,p_plug_template_id=>wwv_flow_imp.id(84074660028486939951)
