...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(84074627338718939938)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84074627625731939938)
,p_plug_template_id=>wwv_flow_imp.id(84074627338718939938)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84074627902069939938)
,p_plug_template_id=>wwv_flow_imp.id(84074627338718939938)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84074628250173939939)
,p_plug_template_id=>wwv_flow_imp.id(84074627338718939938)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84074628506329939939)
,p_plug_template_id=>wwv_flow_imp.id(84074627338718939938)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84074628830969939939)
,p_plug_template_id=>wwv_flow_imp.id(84074627338718939938)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84074629182325939939)
,p_plug_template_id=>wwv_flow_imp.id(84074627338718939938)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84074629422196939939)
,p_plug_template_id=>wwv_flow_imp.id(84074627338718939938)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84074629794750939939)
,p_plug_template_id=>wwv_flow_imp.id(84074627338718939938)
,p_name=>'Sub Regions'
