...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(84073983060998939920)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84073983391696939920)
,p_plug_template_id=>wwv_flow_imp.id(84073983060998939920)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84073983657517939920)
,p_plug_template_id=>wwv_flow_imp.id(84073983060998939920)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84073983974765939920)
,p_plug_template_id=>wwv_flow_imp.id(84073983060998939920)
,p_name=>'Sub Regions'
