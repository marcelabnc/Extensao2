...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(84074622783559939936)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84074623038695939936)
,p_plug_template_id=>wwv_flow_imp.id(84074622783559939936)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84074623316597939937)
,p_plug_template_id=>wwv_flow_imp.id(84074622783559939936)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84074623604533939937)
,p_plug_template_id=>wwv_flow_imp.id(84074622783559939936)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84074623984492939937)
,p_plug_template_id=>wwv_flow_imp.id(84074622783559939936)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84074624236614939937)
,p_plug_template_id=>wwv_flow_imp.id(84074622783559939936)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84074624517499939937)
,p_plug_template_id=>wwv_flow_imp.id(84074622783559939936)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84074624803494939937)
,p_plug_template_id=>wwv_flow_imp.id(84074622783559939936)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84074625103396939937)
,p_plug_template_id=>wwv_flow_imp.id(84074622783559939936)
,p_name=>'Sub Regions'
