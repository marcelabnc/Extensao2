...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(84074639868038939944)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84074640149094939944)
,p_plug_template_id=>wwv_flow_imp.id(84074639868038939944)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84074640474438939944)
,p_plug_template_id=>wwv_flow_imp.id(84074639868038939944)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84074640764145939944)
,p_plug_template_id=>wwv_flow_imp.id(84074639868038939944)
,p_name=>'Sub Regions'
