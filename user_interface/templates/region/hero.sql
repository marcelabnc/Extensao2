...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(84074609237299939931)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84074609526644939931)
,p_plug_template_id=>wwv_flow_imp.id(84074609237299939931)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84074609825776939931)
,p_plug_template_id=>wwv_flow_imp.id(84074609237299939931)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84074610103978939931)
,p_plug_template_id=>wwv_flow_imp.id(84074609237299939931)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84074610419786939931)
,p_plug_template_id=>wwv_flow_imp.id(84074609237299939931)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84074610730928939932)
,p_plug_template_id=>wwv_flow_imp.id(84074609237299939931)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
