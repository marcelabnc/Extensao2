...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(84073950689978939905)
,p_theme_id=>42
,p_name=>'Login'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84073950933509939905)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84073951264645939905)
,p_page_template_id=>wwv_flow_imp.id(84073950689978939905)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84073951521290939905)
,p_page_template_id=>wwv_flow_imp.id(84073950689978939905)
,p_name=>'Body Header'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84073951821917939905)
,p_page_template_id=>wwv_flow_imp.id(84073950689978939905)
,p_name=>'Body Footer'
