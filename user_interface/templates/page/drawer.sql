...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(84073940092152939899)
,p_theme_id=>42
,p_name=>'Drawer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84073940369610939900)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84073940674404939900)
,p_page_template_id=>wwv_flow_imp.id(84073940092152939899)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84073940922117939900)
,p_page_template_id=>wwv_flow_imp.id(84073940092152939899)
