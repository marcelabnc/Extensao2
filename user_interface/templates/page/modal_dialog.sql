...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(84073960629331939909)
,p_theme_id=>42
,p_name=>'Modal Dialog'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84073960908409939909)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84073961261722939910)
,p_page_template_id=>wwv_flow_imp.id(84073960629331939909)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84073961557515939910)
,p_page_template_id=>wwv_flow_imp.id(84073960629331939909)
