...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(84073969248106939913)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84073969525140939913)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84073969884871939913)
,p_page_template_id=>wwv_flow_imp.id(84073969248106939913)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(84073970188497939914)
,p_page_template_id=>wwv_flow_imp.id(84073969248106939913)
